...
namespace Mine2CraftWebApp.Factories
{
    ...
    {
        public static IEnumerable<CompleteItemDto> ToDto(this IEnumerable<Models.CompleteItem> completeItems)
        {
        ...
        public static CompleteItemDto ToDto(this Models.CompleteItem completeItem)
        {
        ...
        public static IEnumerable<Models.CompleteItem> ToModel(this IEnumerable<CompleteItemDto> completeItemDtos)
        {
        ...
        public static Models.CompleteItem ToModel(this CompleteItemDto completeItemDto)
        {
